...
export function UserProfilePage() {
  ...
  if (!user) {
    return <div style={{ padding: 24 }}>{t("admin.errors.userNotFound")}</div>;
  }
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          <div>
            ...
            >
              <div
                style={{ marginBottom: 16, paddingBottom: 16, borderBottom: "1px solid #e5e7eb" }}
              >
                <strong
                  style={{
                    color: "#4b5563",
            ...
            >
              {!user.sites || user.sites.length === 0 ? (
                ...
                >
                  {t("admin.profile.noTenantsAssigned")}
                </div>
              ) : (
                      ...
                      >
                        ...
                        {twoFactorSecret && (
                          ...
                          >
                            ...
                            >
                              {t("admin.twoFactor.orEnterKeyManually")}
                            </p>
                            <code
                              style={{
                      ...
                      <div style={{ display: "flex", gap: 12 }}>
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 600,
                            background:
                              verificationToken.length === 6 && !isVerifying
                                ? "linear-gradient(135deg, #28a745 0%, #20c997 100%)"
                                : "#ddd",
                            color: "white",
                            border: "none",
                        ...
                        >
                          {isVerifying
                            ? t("admin.twoFactor.verifying")
                            : t("admin.twoFactor.verifyAndEnable")}
                        </button>
                        <button
                          onClick={() => {
                            setQrCodeUrl(null);
