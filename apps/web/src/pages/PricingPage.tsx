    ...
    pricingType === "place"
      ? [
          // Place-specific features
          {
            ...
            free:
              getValueWithOverride("free", 3, featureMatrix?.placePlanOverrides, ["images"]) ?? 3,
            basic:
              getValueWithOverride("basic", 15, featureMatrix?.placePlanOverrides, ["images"]) ??
              15,
            pro:
              getValueWithOverride("pro", Infinity, featureMatrix?.placePlanOverrides, [
                "images",
              ]) ?? "∞",
          },
          {
          ...
          },
          {
            ...
            free:
              getValueWithOverride("free", false, featureMatrix?.placePlanOverrides, [
                "featured",
              ]) ?? false,
            basic:
              getValueWithOverride("basic", false, featureMatrix?.placePlanOverrides, [
                "featured",
              ]) ?? false,
            pro:
              getValueWithOverride("pro", true, featureMatrix?.placePlanOverrides, ["featured"]) ??
              true,
          },
          {
            category: t("public.pricing.categories.place") || "Helyszín",
      ...
      : [
          // Site-specific features (existing)
          {
            ...
            free:
              getValueWithOverride("FREE", 3, featureMatrix?.planOverrides, [
                "limits",
                "placesMax",
              ]) ?? 3,
            basic:
              getValueWithOverride("BASIC", 30, featureMatrix?.planOverrides, [
                "limits",
                "placesMax",
              ]) ?? 30,
            pro:
              getValueWithOverride("PRO", 150, featureMatrix?.planOverrides, [
                "limits",
                "placesMax",
              ]) ?? 150,
          },
          {
            ...
            free:
              getValueWithOverride("FREE", 3, featureMatrix?.planOverrides, [
                "limits",
                "galleryImagesPerPlaceMax",
              ]) ?? 3,
            basic:
              getValueWithOverride("BASIC", 10, featureMatrix?.planOverrides, [
                "limits",
                "galleryImagesPerPlaceMax",
              ]) ?? 10,
            pro:
              getValueWithOverride("PRO", 30, featureMatrix?.planOverrides, [
                "limits",
                "galleryImagesPerPlaceMax",
              ]) ?? 30,
          },
          {
            ...
            free:
              getValueWithOverride("FREE", true, featureMatrix?.planOverrides, [
                "features",
                "heroImage",
              ]) ?? true,
            basic:
              getValueWithOverride("BASIC", true, featureMatrix?.planOverrides, [
                "features",
                "heroImage",
              ]) ?? true,
            pro:
              getValueWithOverride("PRO", true, featureMatrix?.planOverrides, [
                "features",
                "heroImage",
              ]) ?? true,
          },
          ...
          },
          {
            ...
            free:
              getValueWithOverride("FREE", false, featureMatrix?.planOverrides, [
                "features",
                "extrasEnabled",
              ]) ?? false,
            basic:
          ...
          // Galleries
          {
            ...
            free:
              getValueWithOverride("FREE", 5, featureMatrix?.planOverrides, [
                "limits",
                "galleriesMax",
              ]) ?? 5,
            basic:
              getValueWithOverride("BASIC", 20, featureMatrix?.planOverrides, [
                "limits",
                "galleriesMax",
              ]) ?? 20,
            pro:
              getValueWithOverride("PRO", Infinity, featureMatrix?.planOverrides, [
                "limits",
                "galleriesMax",
              ]) ?? "∞",
          },
          {
            ...
            free:
              getValueWithOverride("FREE", 10, featureMatrix?.planOverrides, [
                "limits",
                "imagesPerGalleryMax",
              ]) ?? 10,
            basic:
            ...
            pro:
              getValueWithOverride("PRO", 100, featureMatrix?.planOverrides, [
                "limits",
                "imagesPerGalleryMax",
              ]) ?? 100,
          },
          {
            ...
            free:
              getValueWithOverride("FREE", 1, featureMatrix?.planOverrides, [
                "limits",
                "galleriesPerPlaceMax",
              ]) ?? 1,
            basic:
              getValueWithOverride("BASIC", 3, featureMatrix?.planOverrides, [
                "limits",
                "galleriesPerPlaceMax",
              ]) ?? 3,
            pro:
          ...
          },
          {
            ...
            free:
              getValueWithOverride("FREE", 1, featureMatrix?.planOverrides, [
                "limits",
                "galleriesPerEventMax",
              ]) ?? 1,
            basic:
              getValueWithOverride("BASIC", 2, featureMatrix?.planOverrides, [
                "limits",
                "galleriesPerEventMax",
              ]) ?? 2,
            pro:
          ...
          // Visibility
          {
            ...
            free:
              getValueWithOverride("FREE", 0, featureMatrix?.planOverrides, [
                "limits",
                "featuredPlacesMax",
              ]) ?? 0,
            basic:
            ...
            pro:
              getValueWithOverride("PRO", 15, featureMatrix?.planOverrides, [
                "limits",
                "featuredPlacesMax",
              ]) ?? 15,
          },
          ...
          },
          {
            ...
            pro:
              getValueWithOverride("PRO", 200, featureMatrix?.planOverrides, [
                "limits",
                "eventsPerMonthMax",
              ]) ?? 200,
          },
          ...
          // Domain
          {
            ...
            basic:
              getValueWithOverride("BASIC", false, featureMatrix?.planOverrides, [
                "features",
                "customDomainEnabled",
              ]) ?? false,
            pro:
          ...
          // Languages
          {
            ...
            pro:
              getValueWithOverride("PRO", 3, featureMatrix?.planOverrides, [
                "limits",
                "languagesMax",
              ]) ?? 3,
          },
          // Permissions
          {
            ...
            free:
              getValueWithOverride("FREE", 2, featureMatrix?.planOverrides, [
                "limits",
                "siteMembersMax",
              ]) ?? 2,
            basic:
              getValueWithOverride("BASIC", 5, featureMatrix?.planOverrides, [
                "limits",
                "siteMembersMax",
              ]) ?? 5,
            pro:
              getValueWithOverride("PRO", 20, featureMatrix?.planOverrides, [
                "limits",
                "siteMembersMax",
              ]) ?? 20,
          },
          ...
          // Push
          {
            ...
            pro:
              getValueWithOverride(
                "PRO",
                t("public.pricing.features.optionalAddon"),
                featureMatrix?.planOverrides,
                ["features", "pushSubscription"]
              ) ?? t("public.pricing.features.optionalAddon"),
          },
        ];
      ...
      return (
        ...
        >
          ...
          >
            ...
            <path
              d="M12 4.5C9 4.5 7 6 7 8.5C7 10 7.5 11.5 8.5 12.5V13.5H15.5V12.5C16.5 11.5 17 10 17 8.5C17 6 15 4.5 12 4.5Z"
              fill="#667eea"
              stroke="#5568d3"
              strokeWidth="1"
              strokeLinecap="round"
      ...
      return (
        ...
        >
          ...
          >
            ...
            <path
              d="M12 3.5C8.5 3.5 5.5 5.5 5.5 8.5V12.5C5.5 14.5 6.5 16.5 8.5 17.5H15.5C17.5 16.5 18.5 14.5 18.5 12.5V8.5C18.5 5.5 15.5 3.5 12 3.5Z"
              fill="#8b4513"
              stroke="#654321"
              strokeWidth="1.2"
              strokeLinecap="round"
            ...
            <path
              d="M4.5 10.5L3.5 7.5L3 5L4 3.5L5.5 4.5L6 6.5L6.5 8.5L6 10.5L5 11.5L4.5 10.5Z"
              fill="#a0826d"
              stroke="#654321"
              strokeWidth="1.3"
              strokeLinecap="round"
            ...
            <path
              d="M19.5 10.5L20.5 7.5L21 5L20 3.5L18.5 4.5L18 6.5L17.5 8.5L18 10.5L19 11.5L19.5 10.5Z"
              fill="#a0826d"
              stroke="#654321"
              strokeWidth="1.3"
              strokeLinecap="round"
            ...
            <path
              d="M9 17.5V19.5C9 20.5 9.5 21.5 10.5 21.5H13.5C14.5 21.5 15 20.5 15 19.5V17.5"
              stroke="#654321"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <path
              d="M5.5 12.5L5 14.5L6 15.5L6.5 14.5"
              stroke="#654321"
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <path
              d="M18.5 12.5L19 14.5L18 15.5L17.5 14.5"
              stroke="#654321"
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      return (
        ...
        >
          ...
          >
            {/* Crown base - golden */}
            <path
              d="M5 16L3 9L7 11L12 5L17 11L21 9L19 16H5Z"
              fill="#fbbf24"
              stroke="#f59e0b"
              strokeWidth="2"
              strokeLinecap="round"
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: "clamp(40px, 8vw, 64px)" }}>
            ...
            >
              {pricingType === "place"
                ? t("public.pricing.features.placeSubtitle") ||
                  "Válassz egy csomagot a helyszíned számára"
          ...
          >
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns:
                  "minmax(200px, 2.5fr) minmax(100px, 1fr) minmax(100px, 1fr) minmax(100px, 1fr)",
                background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
