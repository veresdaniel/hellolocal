...
export function CollectionDetailPage() {
  ...
  const siteKey = RESERVED_PATHS.includes(routeSiteKey || "") || !routeSiteKey ? DEFAULT_SITE_SLUG : routeSiteKey;
  ...
  const seo = collection
    ? {
        ...
        twitter: {
          card: collection.seo.image || collection.heroImage ? ("summary_large_image" as const) : ("summary" as const),
          title: collection.seo.title || collection.title,
          description: collection.seo.description || collection.description || "",
          image: collection.seo.image || collection.heroImage || undefined,
        },
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "clamp(16px, 4vw, 24px)", paddingTop: "clamp(72px, 8vw, 88px)" }}>
      {/* Hero section */}
