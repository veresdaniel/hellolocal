  ...
  return (
    ...
    >
      <style>{`
        ...
        .site-card:hover .card-read-more span:last-child {
      ...
      `}</style>
      <Link
        to={buildUrl({ lang, siteKey: site.slug, path: "" })}
        style={{
          textDecoration: "none",
          color: "inherit",
          display: "block",
          ...
          >
            <div>
              ...
              {site.shortDescription && (
                ...
                >
                  {site.shortDescription.replace(/<[^>]*>/g, "").substring(0, 100)}
                  {site.shortDescription.length > 100 ? "..." : ""}
                </p>
              )}
            </div>
