...
async function main() {
  ...
  await prisma.legalPage.upsert({
    where: { tenantId_key: { tenantId: tenant.id, key: "imprint" } },
    update: {},
    create: {
      tenantId: tenant.id,
      key: "imprint",
      ...
      translations: {
        create: [
          { lang: "hu", title: "Impresszum", content: "<h2>Impresszum</h2><p>...</p>" },
          { lang: "en", title: "Imprint", content: "<h2>Imprint</h2><p>...</p>" },
          { lang: "de", title: "Impressum", content: "<h2>Impressum</h2><p>...</p>" },
        ],
      },
    },
  });
  ...
  await prisma.legalPage.upsert({
    where: { tenantId_key: { tenantId: tenant.id, key: "terms" } },
    update: {},
    create: {
      tenantId: tenant.id,
      key: "terms",
      ...
      translations: {
        create: [
          { lang: "hu", title: "ÁSZF", content: "<h2>Általános Szerződési Feltételek</h2><p>...</p>" },
          { lang: "en", title: "Terms of Service", content: "<h2>Terms</h2><p>...</p>" },
          { lang: "de", title: "AGB", content: "<h2>AGB</h2><p>...</p>" },
        ],
      },
    },
  });
